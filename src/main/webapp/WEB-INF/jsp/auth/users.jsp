...
<body>
	<form action="user.shtml" method="post" name="userForm" id="userForm">
	...
	<script type="text/javascript">
		...
		function editUser(userId){
			var dg = new $.dialog({
				...
				maxBtn:false,
				resize:false,
				page:'user/edit.shtml?userId='+userId
				});
			dg.ShowDialog();
		}
		...
		function delUser(userId){
			if(confirm("确定要删除该记录？")){
				var url = "user/delete.shtml?userId="+userId;
		...
		function editRights(userId){
			var dg = new $.dialog({
				...
				maxBtn:false,
				resize:false,
				page:'user/auth.shtml?userId='+userId
				});
			dg.ShowDialog();
		}
		...
		function exportUser(){
			document.location = "user/excel.shtml";
		}
	</script>
</body>
</html>