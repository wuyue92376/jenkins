...
<div id="main" >
  <div class="main1200">
      ...
      <div class="sidebar">
        ...
        <div class="column-menu">
          <ul id="seller_center_left_menu">
            ...
            <li><a href="../course/online.shtml">出售中的课程</a></li>
            <li class="current"><a href="javascript:void(0);">仓库中的课程</a> </li>
    ...
    <div class="right">
      <div class="ncsc-path"><i class="icon-desktop"></i>学校管理中心<i class="icon-angle-right">></i>课程<i class="icon-angle-right">></i>仓库中的课程</div>
      <!--online start-->
      <div class="search">
        ...
        <input type="submit" class="cx" value="批量上架"/>
					...
					<li class="clist">
						<dl class="qx">
							...
							<dd class="zjzt">
								...
								<input type="submit" value="上架" onclick="putaway(${c.courseId });" />
							</dd>
						</dl>
					</li>
				</c:forEach>
