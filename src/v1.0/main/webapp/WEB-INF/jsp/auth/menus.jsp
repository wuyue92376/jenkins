	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="main_table">
		...
		<c:choose>
			<c:when test="${not empty menuList}">
				...
				<td>${menu.menuName }</td>
				<td>${menu.menuUrl }</td>
				<td><a href="javascript:void(0);" onclick="openClose(${menu.menuId },this,${vs.index })">展开</a> | 
				<a href="javascript:void(0);" onclick="editmenu(${menu.menuId })">修改</a> | 
				<a href="javascript:void(0);" onclick="delmenu(${menu.menuId },true)">删除</a></td>
				</tr>
				</c:forEach>
			</c:when>
			<c:otherwise>
				...
				$.get(url,function(data){
					...
					if(data.length>0){
						...
						$.each(data,function(i){
							...
							html += "<td><a href='javascript:void(0);' onclick='editmenu("+this.menuId+")'>修改</a> | <a href='javascript:void(0);' onclick='delmenu("+this.menuId+",false)'>删除</a></td>";
							html += "</tr>";
